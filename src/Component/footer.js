            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6 footer-contact" style={{fontSize: '1.5rem'}}>
                ...
                <div className="social-links d-flex align-items-center flex-row flex-nowrap gap-2">
                  <a href="https://www.linkedin.com/in/genkaix" target="_blank" rel="noopener noreferrer"><i className="bi bi-linkedin" /></a>
                  <a href="https://www.linkedin.com/in/genkaix" target="_blank" rel="noopener noreferrer" ><i className="bi bi-facebook" /></a>
                  <a href="https://www.instagram.com/tech.genkaix/" target="_blank" rel="noopener noreferrer" ><i className="bi bi-instagram" /></a>
                  <a href="https://www.linkedin.com/in/genkaix" target="_blank" rel="noopener noreferrer" ><i className="bi bi-twitter" /></a>
                  <a href="https://www.linkedin.com/in/genkaix" target="_blank" rel="noopener noreferrer" className='link-dark text-decoration-none'><i className="bi bi-youtube" /></a>
                </div>
              </div>
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-6 copyright" style={{color: '#fff', fontSize: '1.3rem'}}>
              Copyright © 2025 GenkaiX. All Rights Reserved.
            </div>
          </div>
        </div>
      </div>
